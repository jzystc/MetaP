...
def get_params():
    ...
    args.add_argument(
        "-aggregator", "--aggregator", default="max", choices=["max", "mean"], type=str
    )
...
data_dir = {
    ...
    "rel2candidates_50": "/rel2candidates_50.json",
    "rel2candidates_75": "/rel2candidates_75.json",
    "rel2candidates_100": "/rel2candidates_100.json",
