...
if __name__ == "__main__":
    ...
    if params["mask_ratio"] != 0:
        mask_tail = str("_{}".format(params["mask_ratio"]))
    dataset = dict()
    print("loading train_tasks{} ... ...".format(tail))
    dataset["train_tasks"] = json.load(open(data_dir["train_tasks" + tail + mask_tail]))
    ...
    # parameters=trainer.metaR.parameters()
    # print('# parameters:', sum(param.numel() for param in parameters))
